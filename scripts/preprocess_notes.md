Reorders DIMACS CNF clauses so that no variable index appears in 3 consecutive clauses (sign ignored). I.e., for any variable v, it is forbidden that v appears in clauses i, i+1, and i+2.
